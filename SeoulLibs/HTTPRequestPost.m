...
{
    [NSURLRequest setAllowsAnyHTTPSCertificate:YES forHost:@"m.plum2.kaist.ac.kr"];
...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error
{
    ...
    UIAlertView *loadFailAlert = [[UIAlertView alloc] initWithTitle:@"로딩 실패" message:@"인터넷 연결이 좋지 않아 로딩에 실패하였습니다." delegate:self cancelButtonTitle:@"확인" otherButtonTitles:nil, nil];
    [loadFailAlert show];
}
